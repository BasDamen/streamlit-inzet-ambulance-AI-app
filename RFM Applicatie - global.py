...
data_url = 'https://github.com/BasDamen/streamlit-inzet-ambulance-AI-app.git/raw/main/bronbestand%20AI-model.xlsx'
...
model_url = 'https://github.com/BasDamen/streamlit-inzet-ambulance-AI-app.git/raw/main/random_forest_model.pkl'
RFM = joblib.load(model_url)
